  ...
  try {
    ...
    if (libs.length === 0) {
      ...
      libs.forEach(lib => {
        ...
        html += `
          <div class="library-row ${isSelected ? 'border-accent' : ''} bg-black-500 rounded-lg p-4 flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 transition-colors group" draggable="true" data-id="${lib.id}">
